...
namespace FWBS.OMS.UI.Windows
{
    ...
    /// </summary>
    internal class frmOMSItemV2 : frmDialogV2, ISupportRightToLeft, Interfaces.IShowOMSItem
	{
		#region Fields
		...
		/// they need.
		/// </summary>
		private frmOMSItemV2() : base(TitleBarStyle.Small)
		{
			//
		...
		/// </summary>
		internal frmOMSItemV2(Enquiry enq, int extraHight = 0) : this()
		{
			...
			if (n != Size.Empty)
				this.ClientSize = new Size(LogicalToDeviceUnits(n.Width + enquiryForm1.DockPadding.Left + enquiryForm1.DockPadding.Right) + this.Padding.Horizontal,
                    LogicalToDeviceUnits(n.Height + enquiryForm1.DockPadding.Top + enquiryForm1.DockPadding.Bottom + extraHight) + this.Padding.Vertical + pnlTop.Height);
		}
		...
		internal frmOMSItemV2(string code,  object parent, Common.KeyValueCollection param)
            : this(code, parent, EnquiryMode.Add, param)
        {
		}
		...
		/// <param name="param">Parameters to be used to replace parameters expected within the enquiry object.</param>
		internal frmOMSItemV2(string code, object parent, EnquiryMode mode, Common.KeyValueCollection param)
            : this(Enquiry.GetEnquiry(code, parent, mode, param))
		{
		}
		...
		/// <param name="param">Parameters to be used to replace parameters expected within the enquiry object.</param>
		internal frmOMSItemV2(string code, object parent, EnquiryMode mode, bool offline, Common.KeyValueCollection param)
            : this(Enquiry.GetEnquiry(code, parent, mode, offline, param), 20)
		{
		}
		...
		/// <param name="param">Parameters to be used to replace parameters expected within the enquiry object.</param>
        internal frmOMSItemV2(string code, object parent, FWBS.OMS.Interfaces.IEnquiryCompatible obj, Common.KeyValueCollection param)
            : this(Enquiry.GetEnquiry(code, parent, obj, param), 20)
        {
        }
	    ...
	    private void InitializeComponent()
        {
            ...
            this.pnlTop.Size = new System.Drawing.Size(732, 36);
            ...
            this.enquiryForm1.Location = new System.Drawing.Point(0, 38);
            this.enquiryForm1.Name = "enquiryForm1";
            this.enquiryForm1.Size = new System.Drawing.Size(732, 452);
		...
		protected void cmdCancel_Click(object sender, System.EventArgs e)
		{
			...
			{
				Cursor = Cursors.WaitCursor;
                if (enquiryForm1.IsDirty && !this.Settings.HasFlag(EnquiryFormSettings.DisableIsDirty))
                {
					DialogResult res = MessageBox.Show(Session.CurrentSession.Resources.GetMessage("DIRTYDATAMSG", "Changes have been detected, would you like to save?",""), FWBS.OMS.Global.ApplicationName, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1);
