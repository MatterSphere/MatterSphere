...
namespace FWBS.Logging
{
    ...
    public abstract class TraceListenerBase : TraceListener
	{
		...
		public override sealed void TraceTransfer(TraceEventCache eventCache, string source, int id, string message, Guid relatedActivityId)
		{
			...
			{
				var traceMessage = string.Format(FWBS.Logging.Properties.Resource.TraceListenerBase_TraceMessageFormat, message, relatedActivityId);
		...
		#region TraceWriteAsEvent
		[System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "FWBS.Logging.TraceListenerBase.WriteTrace(System.Diagnostics.TraceEventCache,System.String,System.Diagnostics.TraceEventType,System.Int32,System.String,System.Nullable<System.Guid>,System.Object[])")]
