...
namespace FWBS.Logging
{
    ...
    public class ExpressionFilter : TraceFilter
	{
		...
		private ExpressionBase CompileExpression(string expression)
		{
			...
			source.AppendLine("namespace FWBS.Logging.Dynamic {");
			source.AppendLine("  public class " + className + " : FWBS.Logging.ExpressionFilter.ExpressionBase {");
			...
			var dynamicType = assembly.GetType("FWBS.Logging.Dynamic." + className);
