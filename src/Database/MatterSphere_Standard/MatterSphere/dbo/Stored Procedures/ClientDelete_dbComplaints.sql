...
CREATE PROCEDURE [dbo].[ClientDelete_dbComplaints]
AS
SET NOCOUNT ON
...
BEGIN TRANSACTION
	...
	DELETE dbo.dbComplaints OUTPUT deleted.compID INTO @logTable WHERE clID = @clID
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ClientDelete_dbComplaints] TO [OMSRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[ClientDelete_dbComplaints] TO [OMSAdminRole]
    AS [dbo];
