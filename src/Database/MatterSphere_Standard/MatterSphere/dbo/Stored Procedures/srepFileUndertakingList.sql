...
LEFT JOIN [dbo].[GetCodeLookupDescription]('UNDERTYPE', @UI) cl1 ON cl1.cdCode = U.undType
WHERE
	U.undActive = 1 AND
	F.fileID = @FILEID
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[srepFileUndertakingList] TO [OMSRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[srepFileUndertakingList] TO [OMSAdminRole]
    AS [dbo];
