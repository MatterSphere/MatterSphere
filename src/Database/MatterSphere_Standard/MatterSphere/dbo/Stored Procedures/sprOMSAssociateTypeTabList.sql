...
-- Description:	<Return all tabs for all Associate types>
-- =============================================
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sprOMSAssociateTypeTabList] TO [OMSRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[sprOMSAssociateTypeTabList] TO [OMSAdminRole]
    AS [dbo];
