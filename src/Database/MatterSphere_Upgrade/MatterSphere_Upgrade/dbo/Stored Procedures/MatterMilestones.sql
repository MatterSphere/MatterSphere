...
CREATE PROCEDURE [dbo].[MatterMilestones]
@MATTER_ID bigint
AS
BEGIN
	...
	WHERE dt.MileStoneDescription IS NOT NULL
END
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MatterMilestones] TO [OMSRole]
    AS [dbo];


GO
GRANT EXECUTE
    ON OBJECT::[dbo].[MatterMilestones] TO [OMSAdminRole]
    AS [dbo];
