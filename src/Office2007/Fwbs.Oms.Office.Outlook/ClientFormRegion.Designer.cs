namespace Fwbs.Oms.Office.Outlook
{
    ...
    partial class ClientFormRegion : Microsoft.Office.Tools.Outlook.FormRegionBase
    {
        public ClientFormRegion(Microsoft.Office.Interop.Outlook.FormRegion formRegion)
        ...
        private void InitializeComponent()
        {
            ...
            this.ucOMSTypeEmbeded1.CommandCentreButtonVisible = false;
            ...
            this.Name = "ClientFormRegion";
            this.FormRegionShowing += new System.EventHandler(this.ClientFormRegion_FormRegionShowing);
            this.FormRegionClosed += new System.EventHandler(this.ClientFormRegion_FormRegionClosed);
            this.Click += new System.EventHandler(this.ClientFormRegion_Click);
        ...
        {
            manifest.FormRegionName = "Client Information";
        ...
        public partial class ClientFormRegionFactory : Microsoft.Office.Tools.Outlook.IFormRegionFactory
        {
            ...
            public ClientFormRegionFactory()
            {
                this._Manifest = Globals.Factory.CreateFormRegionManifest();
                ClientFormRegion.InitializeManifest(this._Manifest);
                this.FormRegionInitializing += new Microsoft.Office.Tools.Outlook.FormRegionInitializingEventHandler(this.ClientFormRegionFactory_FormRegionInitializing);
            }
            ...
            {
                ClientFormRegion form = new ClientFormRegion(formRegion);
                form.Factory = this;
                return form;
            }
    ...
    {
        internal ClientFormRegion ClientFormRegion
        {
            get
            {
                foreach (var item in this)
                {
                    if (item.GetType() == typeof(ClientFormRegion))
                        return (ClientFormRegion)item;
                }
                return null;
            }
        }
