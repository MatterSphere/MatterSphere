namespace RTAServicesLibraryV7
{
    ...
    public partial class CT_INPUT_Claim_Details
    {
        ...
        private string oICReferenceNumberField;
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute(Form = System.Xml.Schema.XmlSchemaForm.Qualified)]
        public string OICReferenceNumber
        {
            get
            {
                return this.oICReferenceNumberField;
            }
            set
            {
                this.oICReferenceNumberField = value;
            }
        }
    }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class CT_INPUT_ReferralSourceInfo
    {

        private C32_ReferralSource referralSourceField;

        private string cMCNameField;

        private string mOJCMCAuthorisationNumberField;

        private string referralSourceWebsiteField;

        private string referralSourceSourceField;

        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute(Form = System.Xml.Schema.XmlSchemaForm.Qualified)]
        public C32_ReferralSource ReferralSource
        {
            get
            {
        ...
        public string CMCName
        {
            get
            {
                return this.cMCNameField;
            }
            set
            {
                this.cMCNameField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute(Form = System.Xml.Schema.XmlSchemaForm.Qualified)]
        public string MOJCMCAuthorisationNumber
        {
            get
            {
                return this.mOJCMCAuthorisationNumberField;
            }
            set
            {
                this.mOJCMCAuthorisationNumberField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute(Form = System.Xml.Schema.XmlSchemaForm.Qualified)]
        public string ReferralSourceWebsite
        {
            get
            {
                return this.referralSourceWebsiteField;
            }
            set
            {
                this.referralSourceWebsiteField = value;
            }
        }

        /// <remarks/>
        [System.Xml.Serialization.XmlAttributeAttribute(Form = System.Xml.Schema.XmlSchemaForm.Qualified)]
        public string ReferralSourceSource
        {
            get
            {
                return this.referralSourceSourceField;
            }
            set
            {
                this.referralSourceSourceField = value;
            }
        }
    }
    ...
    public partial class DocumentInputClaimAndClaimantDetailsClaimantRepresentative
    {
        ...
        private CT_INPUT_ReferralSourceInfo referralSourceInfoField;
        ...
        /// <remarks/>
        public CT_INPUT_ReferralSourceInfo ReferralSourceInfo
        {
            get
            {
                return this.referralSourceInfoField;
            }
            set
            {
                this.referralSourceInfoField = value;
            }
        }
    }
    ...
    public partial class DocumentInputLiabilityFunding
    {
        ...
        private DocumentInputLiabilityFundingFunding fundingField;
        ...
        /// <remarks/>
        public DocumentInputLiabilityFundingFunding Funding
        {
            get
            {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class DocumentInputLiabilityFundingFunding
    {
