...
{
    public class ELPLLoginDetails : ICloneable
    {
    ...
    public class ELPLServiceBase
    {
        ...
        //  User Auth Fields
        internal ELPLLoginDetails LoginDetails { get; private set; }
        ...
        public ELPLServiceBase(ELPLLoginDetails loginDetails, ITokenStorageProvider tokenStorageProvider)
        {
            if (loginDetails == null)
                throw new ArgumentNullException(nameof(loginDetails));

            LoginDetails = (ELPLLoginDetails)loginDetails.Clone();
        ...
        /// </summary>
        /// <returns></returns>
        protected PIPService.ELPLService GetELPLService()
        {
            PIPService.ELPLService service = new PIPService.ELPLService();
        ...
        /// Get Proxy
        /// </summary>
        /// <param name="ELPLUrl"></param>
        /// <returns></returns>
        private IWebProxy GetProxy(string ELPLUrl)
        {
            var proxy = WebRequest.DefaultWebProxy;
            Uri resource = new Uri(ELPLUrl);
    ...
    public class ELPLServicePassword : ELPLServiceBase
    {
        #region Constructors
        ...
        /// </summary>
        /// <param name="loginDetails">Login details</param>
        public ELPLServicePassword(ELPLLoginDetails loginDetails) : base(loginDetails, null)
        {
        }
