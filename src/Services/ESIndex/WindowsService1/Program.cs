...
namespace IndexToolService
{
    static class Program
    {
        ...
        {
            MethodInfo method = _service.GetType().GetMethod(methodName, BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        {
            var _appLogger = new AppLogger(LogManager.GetCurrentClassLogger());
            Exception exception = (Exception)e.ExceptionObject;
            _appLogger.Error("Application crash:\r\n" + exception.ToString());
        }
